    ...
    <div className="mx-auto max-w-2xl space-y-6 py-4">
      <div>
        ...
        <p className="mt-1 text-ink-300">
          Tell us a song, style, or vibe — we'll write an original teaching arrangement with chords, tabs, and a strumming pattern.
        </p>
      </div>
      ...
      <div className="card space-y-4 p-5">
        <input
          className="input"
          placeholder='e.g. "a slow acoustic love song" or a song title'
          value={title}
        ...
        <button className="btn-primary w-full" onClick={generate} disabled={loading || !title.trim()}>
          ...
          {loading ? "Writing your arrangement..." : "Generate arrangement"}
        </button>
      </div>
